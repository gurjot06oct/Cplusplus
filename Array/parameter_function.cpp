...
// - Inside the function, the elements is accessed using single dereferencing because `_1d` is a pointer to a 1D array.
...
// - Inside the function, the elements is accessed using double dereferencing  because `_2d` is a pointer to a 2D array.
